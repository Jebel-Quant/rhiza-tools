...
commands for rhiza-tools. It provides headless CI/CD utilities: coverage badge
generation, the CI version matrix, benchmark analysis, dependency auditing, and
README updates.
