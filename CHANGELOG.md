...
- Bump rhiza to v0.14.1 with github-project profile (#189)
- Update rhiza to v0.15.2 (#191)
- Update rhiza to v0.17.0 (#193)
- Bump rhiza workflow stubs v0.16.0 → v0.18.4
## [0.5.0] - 2026-05-18
...
- Bump rhiza template version v0.9.4 → v0.10.1 (#171)
